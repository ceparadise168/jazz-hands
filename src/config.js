...
export const KEYBOARD = {
  cx: 940, // 區域中心(螢幕左右分盤用);整排須在螢幕中線 640 右側,否則最左鍵會被左手搶走
  x0: 624, // 盡量左推到中線右緣(最左鍵左緣 644 > 640),換取更大的 pad
  x1: 1256,
  keys: 7, // C D E F G A B 單排(與左盤和弦的 8 塊脫鉤)
  gap: 40, // 鍵間「靜音間隔」(2026-06-13 再加大:30→40);in-shape 靠它分隔相鄰音
  // 近正方形 pad(高度大減 140→46),縮小「離開鍵」所需的上下擺動 → 利於連續演奏、手不酸
  // (參考 MIDI pad 佈局:均一方形、緊湊、最小移動)。鍵寬 ≈ (x1-x0)/7 - gap ≈ 45。
  keyTop: 354, // 單排琴鍵帶 上緣(垂直置中於 ~379)
  keyBottom: 404, // 下緣(高 50;受限於「7 鍵須在中線右側」的橫向空間天花板,放大到 ~50×50)
